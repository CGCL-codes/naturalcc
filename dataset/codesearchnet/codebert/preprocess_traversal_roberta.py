...
def cli_main():
    ...
    LOGGER.info(args)
    yaml_file = os.path.join(os.path.dirname(__file__), 'config', 'traversal', '{}.yml'.format(args.language))
...
if __name__ == "__main__":
    """
    nohup python -m dataset.csn.codebert.preprocess_traversal_roberta -l ruby > log  2>&1 &
    """
    cli_main()
