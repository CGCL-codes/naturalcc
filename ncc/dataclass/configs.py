...
from ncc.dataclass.constants import (
...
@dataclass
class CommonConfig(NccDataclass):
...
@dataclass
class DistributedTrainingConfig(NccDataclass):
...
@dataclass
class DatasetConfig(NccDataclass):
...
@dataclass
class OptimizationConfig(NccDataclass):
    max_epoch: int = field(
...
@dataclass
class CheckpointConfig(NccDataclass):
    save_dir: str = field(
...
@dataclass
class NccBMUFConfig(NccDataclass):
...
@dataclass
class GenerationConfig(NccDataclass):
    beam: int = field(
        default=5,
...
@dataclass
class CommonEvalConfig(NccDataclass):
...
@dataclass
class EvalLMConfig(NccDataclass):
...
@dataclass
class InteractiveConfig(NccDataclass):
...
class NccConfig(NccDataclass):
    ...
    bmuf: NccBMUFConfig = NccBMUFConfig()
