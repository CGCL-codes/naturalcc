...
from ncc.modules import LayerNorm, MultiheadAttention
from ncc.modules.ncc_dropout import NccDropout
from ncc.modules.quant_noise import quant_noise
...
class TransformerEncoderLayerBase(nn.Module):
    ...
    *cfg.encoder.normalize_before* to ``True``.
    ...
    def __init__(self, cfg, return_fc=False):
        ...
        self.activation_dropout_module = NccDropout(
