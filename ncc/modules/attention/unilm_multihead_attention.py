...
class UnilmMultiheadAttention(nn.Module):
    ...
    def forward(
        ...
        # attn_weights = UnilmMultiheadAttention.apply_sparse_mask(attn_weights, tgt_len, src_len, bsz)
        ...
        attn = attn.permute(0, 2, 1, 3).contiguous().view(bsz, src_len, -1)
