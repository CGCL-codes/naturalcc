...
from .ncc_transformer_decoder_layer import NccTransformerDecoderLayer
from ..ncc_incremental_decoder import NccIncrementalDecoder
from ...encoders.ncc_encoder import EncoderOut
...
class NccTransformerDecoder(NccIncrementalDecoder):
    """
