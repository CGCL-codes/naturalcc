...
from ncc.modules.attention import NccMultiheadAttention
...
class FairTransformerDecoderLayer(TransformerDecoderLayer):
    """Decoder layer block.
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def __init__(
        ...
        self.cross_self_attention = args['model'].get('cross_self_attention', False)
        ...
        self.activation_fn = get_activation(args['model'].get('activation_fn', 'relu'))
