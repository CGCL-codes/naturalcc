...
## Completion Task
1. SeqRNN: ```~/demo/completion/seqrnn/py150.pt```
...
## Summarization Task
1. Neural-Transformer: ```~/demo/summarization/neural_transformer/python_wan.pt```
2. Seq2Seq: ```~/demo/summarization/seq2seq/python_wan.pt```
