...
from ncc.models.transformer import DEFAULT_MIN_PARAMS_TO_WRAP, TransformerEncoder
from ncc.modules import LayerNorm
...
from ncc.utils.utils import safe_getattr, safe_hasattr
...
class RobertaModel(NccEncoderModel):
    @classmethod
    def hub_models(cls):
        return {
...
class RobertaEncoder(NccEncoder):
    """RoBERTa encoder."""
