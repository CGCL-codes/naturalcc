...
import ncc.checkpoint_utils
from ncc.models import (
    NccEncoderDecoderModel,
    register_model,
    register_model_architecture,
)
from ncc.models.transformer import TransformerDecoder
from ncc.models.roberta import model as roberta

logger = logging.getLogger(__name__)


@register_model("roberta_enc_dec")
class RobertaEncDecModel(NccEncoderDecoderModel):
    @staticmethod
    def add_args(parser):
        parser.add_argument(
