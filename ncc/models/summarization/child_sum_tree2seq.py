...
from ncc.modules.encoders.tree import ChildSumTreeLSTMEncoder
from ncc.utils import utils


@register_model('child_sum_tree2seq')
class ChildSumTree2Seq(NccEncoderDecoderModel):
    ...
    def build_model(cls, args, config, task):
        ...
        encoder = ChildSumTreeLSTMEncoder(
