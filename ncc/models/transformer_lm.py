...
from ncc.modules import AdaptiveInput, CharacterTokenEmbedder
...
@dataclass
class TransformerLanguageModelConfig(NccDataclass):
...
class TransformerLanguageModel(NccLanguageModel):
    @classmethod
    def hub_models(cls):
