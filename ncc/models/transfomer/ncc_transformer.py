...
from ncc.modules.decoders.base import NccTransformerDecoder
from ncc.modules.encoders.base import NccTransformerEncoder
from ncc.utils import utils
from .transformer import Transformer


@register_model('ncc_transformer')
class NccTransformer(Transformer):
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        return NccTransformerEncoder(args, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return NccTransformerDecoder(
            args,
            tgt_dict,
            embed_tokens,
