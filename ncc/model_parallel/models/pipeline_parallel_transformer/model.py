...
from ncc.model_parallel.models.pipeline_parallel_transformer.layers import (
    Embedding,
...
from ncc.models.ncc_encoder import EncoderOut
from ncc.models.transformer import (
    base_architecture,
    transformer_iwslt_de_en,
    transformer_wmt_en_de_big,
)
from ncc.modules import SinusoidalPositionalEmbedding
...
class PipelineParallelTransformerModel(BaseNccModel):
    def __init__(self, encoder, decoder, balance, devices, chunks, checkpoint):
        import_pipe()
        super().__init__()
        assert isinstance(encoder, NccEncoder)
        assert isinstance(decoder, NccDecoder)
        encoder_module_list = (
