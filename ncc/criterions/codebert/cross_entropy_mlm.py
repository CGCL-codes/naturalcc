...
@register_criterion('cross_entropy_mlm')
class CrossEntropyMLMCriterion(NccCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        predicted_masked_tokens, _ = model(sample['net_input']['tokens']) # , sample['net_input']['lengths']
