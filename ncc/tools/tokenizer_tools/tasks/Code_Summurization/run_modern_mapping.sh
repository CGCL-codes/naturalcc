...
DATA_DIR="/home/wanyao/wangchen/silver/detasets2/code/code-search-net/processed"
...
OUTPUT_DIR="./saved_models_mapping_RQ3/${modify_type}_${ATTR}/${lang}/"
...
torchrun --nproc_per_node=$NUM_GPUS --master_port=$MASTER_PORT run_modern_mapping.py \
    ...
    --train_file "${DATA_DIR}/${lang}/train_subset.jsonl" \
    --validation_file "${DATA_DIR}/${lang}/valid_subset.jsonl" \
    --test_file "${DATA_DIR}/${lang}/test_subset.jsonl" \
    ...
    2> >(tee "$OUTPUT_DIR/train_stderr.log")
done
