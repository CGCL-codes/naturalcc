...
from ncc.dataclass.configs import DistributedTrainingConfig, NccConfig
...
def distributed_init(cfg: NccConfig):
    ...
    if cfg.common.model_parallel_size > 1:
        try:
            from ncc.model_parallel.megatron.mpu import (
...
def distributed_main(i, main, cfg: NccConfig, kwargs):
...
def call_main(cfg: NccConfig, main, **kwargs):
...
def get_data_parallel_group():
    ...
    global _USE_MEGATRON
    if _USE_MEGATRON:
        from ncc.model_parallel.megatron import mpu
