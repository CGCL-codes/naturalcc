...
from ncc.dataclass.configs import CheckpointConfig
from ncc.dataclass.utils import (
    convert_namespace_to_omegaconf,
    overwrite_args_by_name,
)
from ncc.distributed.fully_sharded_data_parallel import FSDP, has_FSDP
...
def load_model_ensemble(
    ...
    Args:
        ...
        task (ncc.tasks.NccTask, optional): task to use for loading
    """
    assert not (
...
def load_pretrained_component_from_model(
    component: Union[NccEncoder, NccDecoder],
    checkpoint: str,
    strict: bool = True,
):
    """
