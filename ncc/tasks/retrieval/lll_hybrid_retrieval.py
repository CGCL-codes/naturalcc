...
from ncc.tasks.retrieval.hybrid_retrieval import HybridRetrievalTask
...
@register_task('lifelong_hybrid_retrieval')
class LifeLongHybridRetrievalTask(HybridRetrievalTask):
    """
