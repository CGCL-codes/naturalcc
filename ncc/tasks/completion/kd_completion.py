...
# from ncc.data.completion.lll_kd_completion_dataset import KDCompletionDataset
...
class KDCompletionTask(CompletionTask):
    ...
    def load_teacher(self):
        ...
        assert os.path.exists(self.args['kd']['teacher_model']), FileNotFoundError(self.args['kd']['teacher_model'])

        models, _ = checkpoint_utils.load_model_ensemble(
            utils.split_paths(self.args['kd']['teacher_model']),
