...
from ncc.data.completion.topk_kd_completion_dataset import TopkKDCompletionDataset
...
@register_task('topk_kd_completion')
class TopkKDCompletionTask(CompletionTask):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        if split == 'test':
            self.datasets[split] = load_test_token_dataset(
