...
from ncc.data.shorten_dataset import maybe_shorten_dataset
from ncc.dataclass import ChoiceEnum, NccDataclass
from ncc.tasks import LegacyNccTask, register_task
...
@dataclass
class CodeCompletionConfig(NccDataclass):
...
@register_task("code_completion", dataclass=CodeCompletionConfig)
class CodeCompletionTask(LegacyNccTask):
    """
