...
import torch
from ncc import search, tokenizer, utils
from ncc.logging import metrics
from ncc.data import Dictionary, NccDataset, data_utils, encoders, iterators
...
class NccTask(object):
    ...
    def __init__(self, cfg: NccDataclass, **kwargs):
        self.cfg = cfg
        self.datasets = dict()
    ...
    def dataset(self, split):
        ...
        """
        from ncc.data import NccDataset
    ...
    def build_model(self, cfg: NccDataclass, from_checkpoint=False):
        """
        ...
        """
        from ncc import models, quantization_utils
    ...
    def build_generator(
        ...
        if getattr(args, "score_reference", False):
            from ncc.sequence_scorer import SequenceScorer
        ...
        from ncc.sequence_generator import (
            SequenceGenerator,
