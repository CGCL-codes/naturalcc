...
from ncc import checkpoint_utils, models, optim
...
from ncc.models.ema import build_ema
from ncc.nan_detector import NanDetector
from ncc.optim import lr_scheduler
from ncc.utils.utils import safe_hasattr
...
class Trainer(object):
    ...
    def __init__(self, cfg: NccConfig, task, model, criterion, quantizer=None):
    ...
    def get_meter(self, name):
        ...
        if "get_meter" not in self._warn_once:
            ...
            utils.deprecation_warning(
                "Trainer.get_meter is deprecated. Please use ncc.metrics instead."
            )
    ...
    def _xla_markstep_and_send_to_cpu(self, data=None):
        ...
        xm.mark_step()
        if data is not None:
            from ncc.utils.utils import xla_device_to_cpu
