...
def prune_state_dict(state_dict, args):
    ...
    encoder_layers_to_keep = (
        args['model']['encoder_layers_to_keep'] if "encoder_layers_to_keep" in args['model'] else None
    )
    decoder_layers_to_keep = (
        args['model']['decoder_layers_to_keep'] if "decoder_layers_to_keep" in args['model'] else None
    )
    ...
    if "decoder_layers_to_keep" in vars(args):
        args['model']['decoder_layers_to_keep'] = None
