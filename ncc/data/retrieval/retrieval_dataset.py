...
def collate(samples, pad_idx, labels):
    ...
    src_tokens, src_tokens_mask, src_tokens_len = preprocess_input(samples, key='source')
    tgt_tokens, tgt_tokens_mask, tgt_tokens_len = preprocess_input(samples, key='target')
