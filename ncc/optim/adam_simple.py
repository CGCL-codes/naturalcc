...
class NccAdamSimple(NccOptimizer):
    ...
    def __init__(self, args, params):
        ...
        #     not args['optimization']['adam']['use_old_adam']
        ...
        self._optimizer = torch.optim.Adam(params, lr=args['optimization']['lr'][0], betas=(0.9, 0.98), eps=1e-6,
                         weight_decay=0)
    ...
    #         'eps': self.args['optimization']['adam']['adam_eps'],
    #         'weight_decay': self.args['optimization']['adam']['weight_decay'],
    #     }
    #
