...
from ncc.trainers.retrieval.deepcs_trainer import DeepCS_Trainer
...
def single_main(args, init_distributed=False):
    ...
    trainer = DeepCS_Trainer(args, task, model, criterion)
    ...
    while (
        ...
        # INFO >> epoch 001 | valid on 'valid' subset | acc 0.9279 | mrr 0.949322 | map 0.9279 | ndcg 0.9279 (progress_bar.py:269, print())
        # valid_losses = validate(args, trainer, task, epoch_itr, valid_subsets)
        # train for one epoch
