...
def main(args, out_file=None, topk=1):
    ...
    extra_symbols_to_ignore = [
        tgt_dict.bos(), tgt_dict.eos(), tgt_dict.pad(),
        # tgt_dict.index(f"[{src_lang}]"), tgt_dict.index(f"[{tgt_lang}]")
    ]
        ...
        for sample in progress:
            ...
            for i, sample_id in enumerate(sample['id'].tolist()):
                ...
                hypo_str = tgt_dict.string(
                    hypos_tokens, bpe_symbol=args['eval']['remove_bpe'],
...
def cli_main():
    ...
    parser.add_argument(
        ...
        # default='config/codetrans/csharp-java'
        default='config/avatar/top5/python-java'
    )
    parser.add_argument(
