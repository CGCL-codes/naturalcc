...
model_name1 = 'stage1_agent_gpt4o'
model_name2 = 'stage1_agent_gpt4o_opt'
...
result_path1 =f'/data02/projects/vision2ui/results/temp2'
result_path2 =f'/data02/projects/vision2ui/results/temp2_opt'
...
# for index, item in tqdm(enumerate(ds),total=32 ):
    if index < start_index:
        continue  # 跳过 start_index 之前的项

    if index >= start_index + num_to_process:
        break  # 超过32个数据后停止
    image = item['image']
    md5 = image2md5(image)
