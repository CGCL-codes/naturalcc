...
def main(
    ...
    for table_idx, d in enumerate(data):
        ...
        elif perturbation == "anonymized" and dataset == "wtq":
            if d["anonymized_tables"]:
                table = construct_markdown_table(**d["anonymized_tables"])
            else:
                continue
        elif perturbation == "anonymized" and dataset == "tabfact":
            if d["anonymized_table"]:
                table = construct_markdown_table(**d["anonymized_table"])
            else:
                continue
