...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a modified CodeLlama tokenizer from code-text data.")
    parser.add_argument("--base-tokenizer", required=True, help="Path to the base CodeLlama tokenizer.")
