...
infiles_data_final = {'train': '../raw_data/data_database_split/train.json',
                'dev':'../raw_data/data_database_split/valid.json',
                'schema': '../raw_data/tables.json',
                'test': '../raw_data/data_database_split/test.json'
}

infiles_data_radn_split = {'train': '../raw_data/data_radn_split/train.json',
                           'dev': '../raw_data/data_radn_split/valid.json',
                           'schema': '../raw_data/tables.json',
                           'test': '../raw_data/data_radn_split/test.json'
}

prefix_data_final = '../data_final_processed'
prefix_data_radn_split = '../data_radn_split'
infiles = {}
