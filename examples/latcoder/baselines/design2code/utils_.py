...
def all_images_loaded(page:Page, timeout=10):
...
def take_screenshot_single(browser:Browser, html_content, output_file=None):
    try:          
        ...
        page.set_content(html_content, timeout=50000, wait_until='domcontentloaded')
...
def encode_image(image):
    if isinstance(image, Image.Image):
        ...
        raise ValueError('Unsupported input type. Expected a PIL Image object.')

# 
def gemini_encode_image(image):
    return image
