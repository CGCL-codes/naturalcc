...
class UniXcoder(nn.Module):
    def __init__(self, model_name, cache_dir):
        ...
        self.config = RobertaConfig.from_pretrained(model_name, cache_dir = cache_dir)
        self.config.is_decoder = True
        self.model = RobertaModel.from_pretrained(model_name, config=self.config, cache_dir = cache_dir)
